...
public class AttrGroupController {
    ...
    public Resp<List<AttrGroupVo>> queryGroupVOsByCid(@PathVariable("catId")Long catId){
        List<AttrGroupVo> attrGroupVos = attrGroupService.queryGroupVOsByCid(catId);
    ...
    @GetMapping("{catId}")
    public Resp<PageVo> query(@PathVariable(value = "catId")Long catId,QueryCondition queryCondition){

        PageVo pageVo = attrGroupService.queryGroupsByCidPage(catId,queryCondition);
